...
<body class="bg-black text-white min-h-screen">
  ...
  <section class="py-12 px-6 bg-black">
    <h3 class="text-2xl font-bold text-center mb-6">Veja Nosso Vídeo</h3>
    <div class="max-w-3xl mx-auto aspect-w-16 aspect-h-9">
      <iframe class="w-full rounded-lg" height="400" src="https://www.youtube.com/embed/OLXpyD6tlpo" title="Vídeo Institucional" frameborder="0" allowfullscreen></iframe>
    </div>
  </section>
  ...
  <a href="https://www.instagram.com/escrita_inovadora" target="_blank" class="fixed bottom-20 right-5 bg-gradient-to-r from-pink-500 via-red-500 to-yellow-500 text-white px-4 py-3 rounded-full shadow-lg hover:opacity-90 flex items-center space-x-2 z-50">
    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2.2c3.2 0 3.6 0 4.9.1 1.2.1 2 .2 2.4.4.6.2 1.1.5 1.6 1 .5.5.8 1 1 1.6.2.4.3 1.2.4 2.4.1 1.3.1 1.7.1 4.9s0 3.6-.1 4.9c-.1 1.2-.2 2-.4 2.4-.2.6-.5 1.1-1 1.6-.5.5-1 .8-1.6 1-.4.2-1.2.3-2.4.4-1.3.1-1.7.1-4.9.1s-3.6 0-4.9-.1c-1.2-.1-2-.2-2.4-.4-.6-.2-1.1-.5-1.6-1-.5-.5-.8-1-.9-1.6-.3-.4-.4-1.2-.5-2.4C2.2 15.6 2.2 15.2 2.2 12s0-3.6.1-4.9c.1-1.2.2-2 .4-2.4.2-.6.5-1.1 1-1.6.5-.5 1-.8 1.6-1 .4-.2 1.2-.3 2.4-.4C8.4 2.2 8.8 2.2 12 2.2zm0 1.8c-3.1 0-3.5 0-4.7.1-1.1.1-1.7.2-2.1.4-.5.2-.8.4-1.2.8s-.6.7-.8 1.2c-.2.4-.3 1-.4 2.1-.1 1.2-.1 1.6-.1 4.7s0 3.5.1 4.7c.1 1.1.2 1.7.4 2.1.2.5.4.8.8 1.2s.7.6 1.2.8c.4.2 1 .3 2.1.4 1.2.1 1.6.1 4.7.1s3.5 0 4.7-.1c1.1-.1 1.7-.2 2.1-.4.5-.2.8-.4 1.2-.8s.6-.7.8-1.2c.2-.4.3-1 .4-2.1.1-1.2.1-1.6.1-4.7s0-3.5-.1-4.7c-.1-1.1-.2-1.7-.4-2.1-.2-.5-.4-.8-.8-1.2s-.7-.6-1.2-.8c-.4-.2-1-.3-2.1-.4-1.2-.1-1.6-.1-4.7-.1zm0 3.5a5.3 5.3 0 1 1 0 10.6 5.3 5.3 0 0 1 0-10.6zm0 8.8a3.5 3.5 0 1 0 0-7 3.5 3.5 0 0 0 0 7zm5.4-9.7a1.2 1.2 0 1 1-2.4 0 1.2 1.2 0 0 1 2.4 0z"/>
    </svg>
    <span>Instagram</span>
  </a>
